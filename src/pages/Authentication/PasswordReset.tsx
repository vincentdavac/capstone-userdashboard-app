      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" to="/">
                <img
                  className="hidden dark:block h-15 mx-auto"
                  src="./logo/Logo_light_mode.svg"
                  alt="Logo"
                />
                <img
                  className="dark:hidden h-15 mx-auto"
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-screen md:w-auto p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5  font-small hidden sm:block">
