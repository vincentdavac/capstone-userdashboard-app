              ...
              <div className="w-screen p-6 sm:p-12.5 xl:p-17.5">
                ...
                <form>
                  ...
                  <div className="mb-5">
                    ...
                    <Link to='/mobile/forecast' 
                    className="w-full cursor-pointer rounded-lg border border-primary bg-primary p-2 text-white transition hover:bg-opacity-90">Login</Link>
                  </div>
