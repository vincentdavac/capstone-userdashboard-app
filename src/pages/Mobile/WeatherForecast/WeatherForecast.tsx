export default function MobileForecast() {
  ...
  return (
    <div className="w-full mt-2 mb-15 max-w-md mx-auto">
      {/* Box wrapper */}
      <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-4">
        ...
        <div className="flex gap-4 overflow-x-auto sm:grid sm:grid-cols-2 sm:gap-4 no-scrollbar">
          {forecastData.map((day, index) => (
            <div
              key={index}
              className="min-w-[150px] sm:min-w-0 flex flex-col items-center justify-center p-4 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 shadow-sm"
            >
